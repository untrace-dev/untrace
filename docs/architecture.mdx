---
title: 'Architecture'
# description: 'Understanding Acme\'s system design and data flow'
---

## System Overview

Acme consists of several key components working together to provide seamless webhook development:

<div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
  <img src="/images/arch.png" alt="Acme Architecture" />
</div>
...
<Steps>
  <Step title="Webhook Reception">
    - Provider sends webhook to `https://acme.sh/t_123?e=ENDPOINT`
